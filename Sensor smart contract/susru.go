...
type AssetState struct {
    ...
    Status          		*string       `json:"assetstatus,omitempty"`        // the name of the insurance company
	...
	Overallstatus           *string       `json:"overallstatus,omitempty"`  //to indicate whether loss is catastropic or not
